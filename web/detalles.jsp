            ...
            <nav class="navbar" style="padding-top: 0px">
                ...
                <div class="dropdown-menu text-center">
                    ...
                    <section class="contenido wrapper">
                                <div class="texto">
                                    <center><h2><strong>Movimientos</strong></h2>
                                    <h3>Cuenta: <strong>${cuentas.nombre_cuenta}</strong> </h3>
                                    ...
                                    <div class="tabla">
                                        <br>
                                        <p><strong>Movimiento detallado</strong></p>
                                        ...
                                        <strong></strong>
                                            ...
                                            <p>
                                               ...
                                               <strong> Cantidad ingresada: </strong>${movimientos.cantidad} <br>
                                               <strong> Tipo de movimiento: </strong>${movimientos.tipo}<br>
                                               <strong> Fecha de registro: </strong>${movimientos.fecha}<br>
                                               <strong> Categoria: </strong>${movimientos.descripcion}<br>
                                               <strong> Bancos: </strong>${movimientos.descripcion_bancos}<br>
                                               <strong> Descripcion del movimiento: </strong>${movimientos.descripcion_mov}<br>
                                               
                                               <strong> Movimiento realizado a la cuenta: </strong>${cuentas.nombre_cuenta}<br>
                                               <strong> Usuario que registro el movimiento: </strong>${movimientos.nombre} ${movimientos.apellido}<br>
                                               <strong> Detalles de modificacion:</strong><br>
                                               <strong> Fecha de ultima modificacion: </strong>${movimientos.fecha_modificacion}<br>
                                               <strong> Usuario que realizo la modificacion: </strong>${usuariomov.nombre} ${usuariomov.apellido} 
                                         ...
                                         <a href="Movimientoss?id=${movimientos.id_cuenta}"><input type="submit" value="Aceptar" style="background-color: #D3943F;border-color: #D3943F" class="btn btn-danger "/></a>   
