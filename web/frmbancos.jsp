                    ...
                    <a href="Crearu?action=close" class="dropdown-item">Cerrar sesion</a>
                     ...
                     <section class="contenido wrapper">
                                <div class="texto">
                                    ...
                                    <p style="padding-left: 30px;padding-right: 30px">Bienbenido a la administracion de tus metodos de pagos y cobros, en esta seccion 
                                    ...
                                    <div class="tabla">
                                        <br>
                                        <p><strong>Metodos de pago y cobro</strong></p>
                                        <center>
                                        <table style="background: #E9E3DE">
                                            <tr>
                                                    <form action="Bancoss" method="POST" name="frmbancoss">
                                                    <input type ="hidden" name="id" value="${bancos.id}"/>
                                                    <td>
                                                        <label><strong>Descripcion:</strong></label>
                                                    <input type="text" name="descripcion" value="${bancos.descripcion_bancos}" required=""/>
                                                    </td>
                                                    ...
                                                    <a href="Bancoss" ><input style="background-color: #931C1C;border-color: #931C1C" class="btn btn-danger" type="submit" value="Cancelar" /></a>
                                                    </td>
                                            </tr>
                                        </table>
                                        </center>
